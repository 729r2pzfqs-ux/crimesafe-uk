...
def generate_safest_page(rankings, top_n=100):
    ...
    desc = (
        ...
        f"Areas scored 80–100/100 based on official July 2026 "
    ...
    <main id="main-content">
        ...
        <section class="hero" style="padding: var(--space-8) 0;">
            <div class="container">
                ...
                <p class="hero-sub">Top {top_n} neighbourhoods with lowest crime rates • July 2026 data</p>
            </div>
        </section>
...
def generate_dangerous_page(rankings, bottom_n=100):
    ...
    desc = (
        ...
        f"Areas scored 0–20/100 based on official July 2026 "
        f"data from police.uk."
    )
    ...
    <main id="main-content">
        ...
        <section class="hero" style="padding: var(--space-8) 0;">
            <div class="container">
                ...
                <p class="hero-sub">Top {bottom_n} neighbourhoods with highest crime rates • July 2026 data</p>
            </div>
        </section>
