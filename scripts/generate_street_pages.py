    ...
    {{
        ...
        "itemListElement": [
            {{
                ...
                "position": 1,
                "name": "Home",
                "item": "https://crimesafe.uk/"
            }},
            {{
                "@type": "ListItem",
                "position": 2,
                "name": "Streets",
                "item": "https://crimesafe.uk/streets/"
            }},
            {{
                "@type": "ListItem",
                "position": 3,
                "name": "{street_name}",
                "item": "https://crimesafe.uk/streets/{slug}/"
            }}
        ]
    }}
    </script>
...
<body>
        ...
        <section style="margin-bottom: var(--space-8);">
            <a href="/maps/street-crime/?lat={lat}&lng={lng}" class="card" style="display: flex; align-items: center; gap: var(--space-4); padding: var(--space-5); text-decoration: none; background: linear-gradient(135deg, var(--color-primary) 0%, #0891b2 100%); color: white; border-radius: var(--radius-lg);">
                ...
                <div>
                    ...
                    <div style="opacity: 0.9; font-size: var(--text-sm);">See street-level crime around {street_name}</div>
                </div>
    ...
    <section style="margin-bottom: var(--space-8);">
            <h2 style="font-size: var(--text-xl); margin-bottom: var(--space-4);">Explore More Streets</h2>
            <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)); gap: var(--space-3);">
                <a href="/streets/oxford-street/" class="card" style="padding: var(--space-3); text-decoration: none; font-size: var(--text-sm);">Oxford Street</a>
                <a href="/streets/leicester-square/" class="card" style="padding: var(--space-3); text-decoration: none; font-size: var(--text-sm);">Leicester Square</a>
                <a href="/streets/camden-high-street/" class="card" style="padding: var(--space-3); text-decoration: none; font-size: var(--text-sm);">Camden High Street</a>
                <a href="/streets/brick-lane/" class="card" style="padding: var(--space-3); text-decoration: none; font-size: var(--text-sm);">Brick Lane</a>
                <a href="/streets/soho-street/" class="card" style="padding: var(--space-3); text-decoration: none; font-size: var(--text-sm);">Soho Street</a>
                <a href="/streets/" class="card" style="padding: var(--space-3); text-decoration: none; font-size: var(--text-sm); background: var(--color-primary); color: white;">View All Streets →</a>
            </div>
        </section>
    </main>
    ...
    <footer style="border-top: 1px solid var(--color-divider); padding: var(--space-8) 0; text-align: center;">
        <div class="container">
            ...
            <p style="color: var(--color-text-faint); font-size: var(--text-xs); margin-top: var(--space-2);">
                Contains public sector information licensed under the <a href="https://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/" target="_blank" rel="license noopener">Open Government Licence v3.0</a>.
            </p>
        </div>
    </footer>
