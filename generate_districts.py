...
def generate_districts_index(districts):
    ...
    _crumbs = '<script type="application/ld+json">' + json.dumps(
        ...
        ensure_ascii=False) + '</script>\n'
    html = get_header("UK District Crime Statistics 2026 | 65 Areas", "Browse crime rates and safety scores for 65 UK districts. Compare neighbourhoods by area using official July 2026 police data from police.uk.",
